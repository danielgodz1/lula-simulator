...
export const RUNNER_CHARACTERS = [
  {
    ...
    name_en: 'Wall Street Businessman',
    nickname: 'O Faria Limer',
    nickname_en: 'The Faria Limer',
    ...
    desc_en: 'Italian suit, dark sunglasses, leather briefcase, running away from taxes across the hills.',
  ...
  },
  {
    ...
    desc_en: 'Satirical caricature of the President on the run! Navy presidential suit and golden sash.',
    cost: 300, // 300 moedas
    sprite: '/img/lula.png',
    themeColor: '#ffdf00'
  },
  {
    id: 'bolsonaro',
    name: 'Jair Bolsonaro',
    name_en: 'Jair Bolsonaro',
    nickname: 'O Capitão',
    nickname_en: 'The Captain',
    title: 'Jair Bolsonaro — O Capitão',
    ...
    desc_en: 'Satirical caricature of the Captain! Dark suit, patriotic tie, and presidential sash.',
    cost: 500, // 500 moedas
    sprite: '/img/bolsonaro.png',
    themeColor: '#22c55e'
  }
